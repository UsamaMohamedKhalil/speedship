...
export const SidebarData = [
  ...
  //   iconOpened: <KeyboardArrowDownIcon />,
  //   subNav: [
  //     { title: "File Manager", path: "/apps/file-manager/" },
  //     { title: "Chat", path: "/apps/chat/" },
  //     { title: "To Do", path: "/apps/to-do/" },
  ...
  //     { title: "Read Email", path: "/email/read-email/" },
  //   ],
  // },
  // Add more items here as needed (commented out for now)
